    ...
    public partial class FormItemSalesReport : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "select * from SalesInformation";
                ...
                for (int i = 0; i < dataGridView1.Rows.Count; ++i)
                {
                    sum1 += Convert.ToDecimal(dataGridView1.Rows[i].Cells[13].Value);
                }
            ...
            else
            {
                ...
                try
                {
                    ...
                    if (comboBoxSearchBy.Text == "Item Code")
                    {
                        ...
                        query = "select * from SalesInformation Where SalesDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "' And ItemCode='" + textBoxQuery.Text + "'";
                    }

                    else if (comboBoxSearchBy.Text == "Item Name")
                    {
                        query = "select * from SalesInformation Where SalesDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "' And ItemName='" + textBoxQuery.Text + "'";
                    }

                    else if (comboBoxSearchBy.Text == "Group Name")
                    {
                        query = "select * from SalesInformation Where SalesDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "' And ItemGroup='" + textBoxQuery.Text + "'";
                    }

                    else if (comboBoxSearchBy.Text == "Company Name")
                    {
                        query = "select * from SalesInformation Where SalesDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "' And ItemCompany='" + textBoxQuery.Text + "'";
                    }
                    ...
                    {
                        query = "select * from SalesInformation Where InvoiceNumber='" + textBoxQuery.Text + "'";
                    }


                    else if (comboBoxSearchBy.Text == "Serial Number")
                    {
                        query = "select * from SalesInformation Where SerialNumber='" + textBoxQuery.Text + "'";
                    }


                    else if (comboBoxSearchBy.Text == "Date To Date")
                    {
                        query = "select * from SalesInformation Where SalesDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "'";
                    }
        ...
        void AutoComplete1()
        {
            ...
            try
            {
                ...
                command.CommandText = "select * from SalesInformation";
        ...
        void AutoComplete2()
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    string groupName = reader["ItemGroup"].ToString();
                    coll.Add(groupName);
                }
        ...
        void AutoComplete3()
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    string groupName = reader["ItemCompany"].ToString();
                    coll.Add(groupName);
                }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                PdfWriter wri = PdfWriter.GetInstance(doc, new FileStream(System.AppDomain.CurrentDomain.BaseDirectory.ToString() + "\\Documents\\ItemSales Report" + DateTime.Now.Date.ToString("ddMMyyyy") + ".pdf", FileMode.Create));
                ...
                PdfPCell cell = new PdfPCell(new Phrase("Item-Sales Report"));
                ...
                System.Diagnostics.Process.Start(System.AppDomain.CurrentDomain.BaseDirectory.ToString() + "\\Documents\\ItemSales Report" + DateTime.Now.Date.ToString("ddMMyyyy") + ".pdf");
            }
        }
    }
}
