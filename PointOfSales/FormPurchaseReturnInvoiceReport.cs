...
{
    public partial class FormPurchaseReturnInvoiceReport : Form
    {
        ...
        public string query;
        public FormPurchaseReturnInvoiceReport()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string query = "select * from PurchaseReturnInvoiceInformation";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                PdfWriter wri = PdfWriter.GetInstance(doc, new FileStream(System.AppDomain.CurrentDomain.BaseDirectory.ToString() + "\\Documents\\Purchase_Return_Inv_Report" + DateTime.Now.Date.ToString("ddMMyyyy") + ".pdf", FileMode.Create));
                ...
                PdfPCell cell = new PdfPCell(new Phrase("Purchase Return Invoice Report"));
                ...
                System.Diagnostics.Process.Start(System.AppDomain.CurrentDomain.BaseDirectory.ToString() + "\\Documents\\Purchase_Return_Inv_Report" + DateTime.Now.Date.ToString("ddMMyyyy") + ".pdf");
            }
        }
            ...
            else
            {
                ...
                try
                {
                    ...
                    if (comboBoxSearchBy.Text == "Invoice Number")
                    {
                        ...
                        query = "select * from PurchaseReturnInvoiceInformation Where InvoiceNumber='" + textBoxQuery.Text + "'";
                    }

                    else if (comboBoxSearchBy.Text == "Supplier Name")
                    {
                        query = "select * from PurchaseReturnInvoiceInformation Where PurchaseDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "' And SupplierName='" + textBoxQuery.Text + "'";
                    }

                    else if (comboBoxSearchBy.Text == "Account Number")
                    {
                        query = "select * from PurchaseReturnInvoiceInformation Where PurchaseDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "' And AccountNumber='" + textBoxQuery.Text + "'";
                    }

                    else if (comboBoxSearchBy.Text == "Contact Number")
                    {
                        query = "select * from PurchaseReturnInvoiceInformation Where PurchaseDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "' And ContactNumber='" + textBoxQuery.Text + "'";
                    }

                    else if (comboBoxSearchBy.Text == "Operator Name")
                    {
                        query = "select * from PurchaseReturnInvoiceInformation Where PurchaseDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "' And OperatorName='" + textBoxQuery.Text + "'";
                    }


                    else if (comboBoxSearchBy.Text == "Date To Date")
                    {
                        query = "select * from PurchaseReturnInvoiceInformation Where PurchaseDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "'";
                    }
            ...
            if (e.ColumnIndex == 13)
            {
                ...
                if (dr == DialogResult.Yes)
                {
                    ...
                    try
                    {
                        ...
                        string query = "update PurchaseReturnInvoiceInformation set TotalDue='" + "0" + "' where ID=" + row.Cells[0].Value.ToString() + " ";
