...
{
    public partial class FormSalesReturnInvoiceReport : Form
    {
        ...
        public string query;
        public FormSalesReturnInvoiceReport()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string query = "select * from SalesReturnInvoiceInformation";
                ...
                dataGridView1.Columns[9].HeaderText = "Customer Name";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                PdfWriter wri = PdfWriter.GetInstance(doc, new FileStream(System.AppDomain.CurrentDomain.BaseDirectory.ToString() + "\\Documents\\Sales Return Inv Report" + DateTime.Now.Date.ToString("ddMMyyyy") + ".pdf", FileMode.Create));
                ...
                PdfPCell cell = new PdfPCell(new Phrase("Sales Return Invoice Report"));
                ...
                System.Diagnostics.Process.Start(System.AppDomain.CurrentDomain.BaseDirectory.ToString() + "\\Documents\\Sales Return Inv Report" + DateTime.Now.Date.ToString("ddMMyyyy") + ".pdf");
            }
        }
            ...
            else
            {
                ...
                try
                {
                    ...
                    if (comboBoxSearchBy.Text == "Invoice Number")
                    {
                        ...
                        query = "select * from SalesReturnInvoiceInformation Where InvoiceNumber='" + textBoxQuery.Text + "'";
                    }

                    else if (comboBoxSearchBy.Text == "Customer Name")
                    {
                        query = "select * from SalesReturnInvoiceInformation Where PurchaseDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "' And SupplierName='" + textBoxQuery.Text + "'";
                    }

                    else if (comboBoxSearchBy.Text == "Account Number")
                    {
                        query = "select * from SalesReturnInvoiceInformation Where PurchaseDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "' And AccountNumber='" + textBoxQuery.Text + "'";
                    }

                    else if (comboBoxSearchBy.Text == "Contact Number")
                    {
                        query = "select * from SalesReturnInvoiceInformation Where PurchaseDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "' And ContactNumber='" + textBoxQuery.Text + "'";
                    }

                    else if (comboBoxSearchBy.Text == "Operator Name")
                    {
                        query = "select * from SalesReturnInvoiceInformation Where PurchaseDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "' And OperatorName='" + textBoxQuery.Text + "'";
                    }


                    else if (comboBoxSearchBy.Text == "Date To Date")
                    {
                        query = "select * from SalesReturnInvoiceInformation Where PurchaseDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "'";
                    }
        ...
        {
            if (comboBoxSearchBy.Text == "Customer Name")
            {
                AutoComplete1();
            }
            ...
            if (e.ColumnIndex == 13)
            {
                ...
                if (dr == DialogResult.Yes)
                {
                    ...
                    try
                    {
                        ...
                        string query = "update SalesReturnInvoiceInformation set TotalDue='" + "0" + "' where ID=" + row.Cells[0].Value.ToString() + " ";
