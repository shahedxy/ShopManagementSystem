...
{
    public partial class FormPurchaseReturnItem : Form
    {
        ...
        private void FormPurchase_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                command.CommandText = "select * from PurchaseReturnInvoiceInformation";
        ...
        private void textBoxSearchName_TextChanged(object sender, EventArgs e)
        {
            ...
            else if(comboBoxReplacement.Text=="Yes")
            {
                ...
                try
                {
                    ...
                    command.CommandText = "select * from ReplacementInformation where ItemName='" + textBoxSearchName.Text + "' ";
                    ...
                    if (reader.Read())
                    {
                        labelItemName.Text = reader["ItemName"].ToString();
                        labelItemCode.Text = reader["ItemCode"].ToString();
                        textBoxPurchaseRate.Text = reader["RatePrice"].ToString();
                        labelCompanyName.Text = reader["CompanyName"].ToString();
                        labelGroupName.Text = reader["GroupName"].ToString();
                        labelItemUnit.Text = reader["ItemUnit"].ToString();
                        labelShelfNumber.Text = reader["SelfNumber"].ToString();
        ...
        private void textBoxSearchCode_TextChanged(object sender, EventArgs e)
        {
            ...
            else if (comboBoxReplacement.Text == "Yes")
            {
                ...
                try
                {
                    ...
                    command.CommandText = "select * from ReplacementInformation where ItemCode='" + textBoxSearchCode.Text + "' ";
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                    ...
                    try
                    {
                        ...
                        if (reader.Read())
                        {
                            try
                            {
                                ...
                                MessageBox.Show("Item Has Been Purchase Retured Successfully.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    ...
                    try
                    {
                        ...
                        if (reader.Read())
                        {
                            try
                            {
                                ...
                                MessageBox.Show("Item Has Been Replaced Successfully.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
                ...
                try
                {
                    ...
                    string query = "select * from PurchaseReturnItemInformation Where InvoiceNumber='" + labelInvoiceNumber.Text + "'";
            ...
            else
            {
                ...
                if (dr == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        command.CommandText = "delete from PurchaseReturnItemInformation where ID=" + labelEid.Text + "";
            ...
            if (textBoxDiscount.Text == "" || labelPayable.Text == "" || textBoxTotalPaid.Text == "" || dataGridView1.Rows.Count == 0)
                ...
                else
                {
                    ...
                    if (textBoxPreviousBalance.Text == "" && textBoxCurrentBalance.Text == "")
                    {
                        ...
                        PdfWriter wri = PdfWriter.GetInstance(doc, new FileStream(System.AppDomain.CurrentDomain.BaseDirectory.ToString() + "\\Purchase Return Invoice\\Purchase_Return_Inv" + labelInvoiceNumber.Text + ".pdf", FileMode.Create));
                       ...
                       // CellNine999.Colspan = 4;
                        ...
                        System.Diagnostics.Process.Start(System.AppDomain.CurrentDomain.BaseDirectory.ToString() + "\\Purchase Return Invoice\\Purchase_Return_Inv" + labelInvoiceNumber.Text + ".pdf");
                        ...
                        else
                        {
                            ...
                            if (textBoxTotalPaid.Text != "0")
                            {
                                try
                                {
                                    ...
                                    SqlCommand command2 = new SqlCommand();
                                    command2.Connection = connection;
                                    command2.CommandText = "INSERT INTO TransactionInfo (TrxnDate, AccountNumber, AccountName, AccountCategory, PreviousBalance, CreditAmount, DebitAmount, CurrentBalance, OperatorName, ReceiptNumber, TrxnType) VALUES ('" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "','" + labelAccountNumber.Text + "','" + textBoxAccountName.Text + "','" + accountCategory + "','" + tempCurrentBalance.ToString() + "','" + textBoxTotalPaid.Text + "','" + "0" + "','" + textBoxCurrentBalance.Text + "','" + realName + "','" + "PR Inv-" + labelInvoiceNumber.Text + "','" + "Sales Return" + "')";
                                    command2.ExecuteNonQuery();
                                    connection.Close();
