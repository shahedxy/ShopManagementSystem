...
namespace PointOfSales
{
    public partial class FormDamageReport : Form
    {
        ...
        private void FormDamageReport_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "select * from DamageInformation";
                ...
                dataGridView1.Columns[2].HeaderText = "Item Code";
                dataGridView1.Columns[3].HeaderText = "Item Name";
                ...
                dataGridView1.Columns[9].HeaderText = "Total Price";
                dataGridView1.Columns[10].HeaderText = "Supplier/Customer Name";
                dataGridView1.Columns[11].HeaderText = "Activity Type";
            ...
            else
            {
                ...
                try
                {
                    ...
                    if (comboBoxSearchBy.Text == "Item Code")
                    {
                        ...
                        query = "select * from DamageInformation Where PurchaseDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "' And ItemCode='" + textBoxQuery.Text + "'";
                    }

                    else if (comboBoxSearchBy.Text == "Item Name")
                    {
                        query = "select * from DamageInformation Where PurchaseDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "' And ItemName='" + textBoxQuery.Text + "'";
                    }

                    else if (comboBoxSearchBy.Text == "Group Name")
                    {
                        query = "select * from DamageInformation Where PurchaseDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "' And GroupName='" + textBoxQuery.Text + "'";
                    }

                    else if (comboBoxSearchBy.Text == "Company Name")
                    {
                        query = "select * from DamageInformation Where PurchaseDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "' And CompanyName='" + textBoxQuery.Text + "'";
                    }



                    else if (comboBoxSearchBy.Text == "Supplier Customer Name")
                    {
                        query = "select * from DamageInformation Where PurchaseDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "' And Returner='" + textBoxQuery.Text + "'";
                    }


                    else if (comboBoxSearchBy.Text == "User")
                    {
                        query = "select * from DamageInformation Where PurchaseDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "' And OperatorName='" + textBoxQuery.Text + "'";
                    }

                    else if (comboBoxSearchBy.Text == "Activity Type")
                    {
                        query = "select * from DamageInformation Where PurchaseDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "' And ActivityType='" + textBoxQuery.Text + "'";
                    }

                    else if (comboBoxSearchBy.Text == "Date To Date")
                    {
                        query = "select * from DamageInformation Where PurchaseDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "'";
                    }
        ...
        void AutoComplete1()
        {
            ...
            try
            {
                ...
                command.CommandText = "select * from DamageInformation";
        ...
        void AutoComplete4()
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    string groupName = reader["Returner"].ToString();
                    coll.Add(groupName);
                }
        ...
        void AutoComplete6()
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    string groupName = reader["ActivityType"].ToString();
                    coll.Add(groupName);
                }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            PdfWriter wri = PdfWriter.GetInstance(doc, new FileStream(System.AppDomain.CurrentDomain.BaseDirectory.ToString() + "\\Documents\\DamageReturn Report" + DateTime.Now.Date.ToString("ddMMyyyy") + ".pdf", FileMode.Create));
            ...
            PdfPCell cell = new PdfPCell(new Phrase("Damage/Return Report"));
            ...
            System.Diagnostics.Process.Start(System.AppDomain.CurrentDomain.BaseDirectory.ToString() + "\\Documents\\DamageReturn Report" + DateTime.Now.Date.ToString("ddMMyyyy") + ".pdf");
        }
    }
}
