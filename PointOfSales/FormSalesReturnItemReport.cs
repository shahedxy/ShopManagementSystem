...
{
    public partial class FormSalesReturnItemReport : Form
    {
        ...
        public FormSalesReturnItemReport()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "select * from SalesReturnItemInformation";
            ...
            else
            {
                ...
                try
                {
                    ...
                    if (comboBoxSearchBy.Text == "Item Code")
                    {
                        ...
                        query = "select * from SalesReturnItemInformation Where PurchaseDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "' And ItemCode='" + textBoxQuery.Text + "'";
                    }

                    else if (comboBoxSearchBy.Text == "Item Name")
                    {
                        query = "select * from SalesReturnItemInformation Where PurchaseDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "' And ItemName='" + textBoxQuery.Text + "'";
                    }

                    else if (comboBoxSearchBy.Text == "Group Name")
                    {
                        query = "select * from SalesReturnItemInformation Where PurchaseDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "' And GroupName='" + textBoxQuery.Text + "'";
                    }

                    else if (comboBoxSearchBy.Text == "Company Name")
                    {
                        query = "select * from SalesReturnItemInformation Where PurchaseDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "' And CompanyName='" + textBoxQuery.Text + "'";
                    }
                    ...
                    {
                        query = "select * from SalesReturnItemInformation Where InvoiceNumber='" + textBoxQuery.Text + "'";
                    }


                    else if (comboBoxSearchBy.Text == "Date To Date")
                    {
                        query = "select * from SalesReturnItemInformation Where PurchaseDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "'";
                    }
        ...
        void AutoComplete1()
        {
            ...
            try
            {
                ...
                command.CommandText = "select * from SalesReturnItemInformation";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                PdfWriter wri = PdfWriter.GetInstance(doc, new FileStream(System.AppDomain.CurrentDomain.BaseDirectory.ToString() + "\\Documents\\Sales_Return_Item_Report" + DateTime.Now.Date.ToString("ddMMyyyy") + ".pdf", FileMode.Create));
                ...
                PdfPCell cell = new PdfPCell(new Phrase("Sales Return Item Report"));
                ...
                System.Diagnostics.Process.Start(System.AppDomain.CurrentDomain.BaseDirectory.ToString() + "\\Documents\\Sales_Return_Item_Report" + DateTime.Now.Date.ToString("ddMMyyyy") + ".pdf");
            }
        }
    }
}
