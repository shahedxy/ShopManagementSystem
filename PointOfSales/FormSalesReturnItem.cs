...
{
    public partial class FormSalesReturnItem : Form
    {
        ...
        private void FormPurchase_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                command.CommandText = "select * from SalesReturnInvoiceInformation";
        ...
        private void textBoxSearchName_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (reader.Read())
                {
                    ...
                    textBoxPurchaseRate.Text = reader["SalePrice"].ToString();
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    command.CommandText = "INSERT INTO SalesReturnItemInformation (PurchaseDate, InvoiceNumber, ItemCode, ItemName, GroupName, CompanyName, ItemUnit, PurchaseQuantity, PurchasePrice, TotalPrice) VALUES ('" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "','" + labelInvoiceNumber.Text + "','" + labelItemCode.Text + "','" + labelItemName.Text + "','" + labelGroupName.Text + "','" + labelCompanyName.Text + "','" + labelItemUnit.Text + "','" + textBoxPurchaseQuantity.Text + "','" + textBoxPurchaseRate.Text + "','" + textBoxTotalPrice.Text + "')";
                    ...
                    try
                    {
                        ...
                        if (reader.Read())
                        {
                            try
                            {
                                ...
                                MessageBox.Show("Item Has Been Sales Returned Successfully.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        ...
                        else
                        {
                            ...
                            try
                            {
                                ...
                                MessageBox.Show("Item Has Been Returned Successfully.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
                ...
                else if (comboBoxReplacement.Text == "Yes")
                {
                    try
                    {
                        connection.Open();
                        ...
                        command3.CommandText = ("Select * From ReplacementInformation where ItemCode='" + labelItemCode.Text + "'");
                        ...
                        if (reader.Read())
                        {
                            try
                            {
                                ...
                                string query = "update ReplacementInformation set AvailableQuantity='" + totalQuantity + "' where ID=" + ID + " ";
                        ...
                        else
                        {
                            ...
                            try
                            {
                                ...
                                command2.CommandText = "INSERT INTO ReplacementInformation (ItemCode, ItemName, GroupName, CompanyName, ItemUnit, SelfNumber,  AvailableQuantity, RatePrice) VALUES ('" + labelItemCode.Text + "','" + labelItemName.Text + "','" + labelGroupName.Text + "','" + labelCompanyName.Text + "','" + labelItemUnit.Text + "','" + labelShelfNumber.Text + "','" + textBoxPurchaseQuantity.Text + "','" + textBoxPurchaseRate.Text + "')";
                    ...
                    try
                    {
                        ...
                        if (reader.Read())
                        {
                            try
                            {
                                ...
                                MessageBox.Show("Item Has Been Sales Replaced Successfully.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
                ...
                try
                {
                    ...
                    string query = "select * from SalesReturnItemInformation Where InvoiceNumber='" + labelInvoiceNumber.Text + "'";
            ...
            else
            {
                ...
                if (dr == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        command.CommandText = "delete from SalesReturnItemInformation where ID=" + labelEid.Text + "";
                ...
                else
                {
                    ...
                    if (textBoxPreviousBalance.Text == "" && textBoxCurrentBalance.Text == "")
                    {
                        ...
                        try
                        {
                            ...
                            command.CommandText = "INSERT INTO SalesReturnInvoiceInformation (InvoiceNumber, TotalItem, TotalPrice, DiscountAmmount, PayablePrice, PaidAmount, TotalDue, OperatorName, PurchaseDate, SupplierName,AccountNumber,ContactNumber) VALUES ('" + labelInvoiceNumber.Text + "','" + labelTotalQuantity.Text + "','" + labelTotalPrice.Text + "','" + textBoxDiscount.Text + "','" + labelPayable.Text + "','" + textBoxTotalPaid.Text + "','" + labelcChangeDue.Text + "','" + realName + "','" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "','" + textBoxAccountName.Text + "','" + labelAccountNumber.Text + "','" + textBoxContactNumber.Text + "')";
                        ...
                        PdfWriter wri = PdfWriter.GetInstance(doc, new FileStream(System.AppDomain.CurrentDomain.BaseDirectory.ToString() + "\\Sales Return Invoice\\Sales_Return_Invoice_Number_" + labelInvoiceNumber.Text + ".pdf", FileMode.Create));
                        ...
                        {
                            PdfPCell CellNine1 = new PdfPCell(new Phrase("Replacement Invoice No: " + labelInvoiceNumber.Text + "\nTotal Item: " + labelTotalItem.Text + " & Qty: " + labelTotalQuantity.Text + "\nTime: " + DateTime.Now.ToString("hh:mm:ss tt") + "\nDate: " + DateTime.Now.ToString("dd.MM.yyyy") + "\nServed By: " + realName, fontTable3));
                            CellNine1.Border = iTextSharp.text.Rectangle.NO_BORDER;
                            CellNine1.HorizontalAlignment = Element.ALIGN_LEFT;
                            table6.AddCell(CellNine1);
                        }
                        ...
                        System.Diagnostics.Process.Start(System.AppDomain.CurrentDomain.BaseDirectory.ToString() + "\\Sales Return Invoice\\Sales_Return_Invoice_Number_" + labelInvoiceNumber.Text + ".pdf");
                        ...
                        comboBoxReplacement.SelectedIndex = -1;
                        ...
                        else
                        {
                            ...
                            if (textBoxTotalPaid.Text != "0")
                            {
                                ...
                                try
                                {
                                    ...
                                    SqlCommand command2 = new SqlCommand();
                                    command2.Connection = connection;
                                    command2.CommandText = "INSERT INTO TransactionInfo (TrxnDate, AccountNumber, AccountName, AccountCategory, PreviousBalance, CreditAmount, DebitAmount, CurrentBalance, OperatorName, ReceiptNumber, TrxnType) VALUES ('" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "','" + labelAccountNumber.Text + "','" + textBoxAccountName.Text + "','" + accountCategory + "','" + tempCurrentBalance.ToString() + "','" + "0" + "','" + textBoxTotalPaid.Text + "','" + textBoxCurrentBalance.Text + "','" + realName + "','" + "SR Inv-" + labelInvoiceNumber.Text + "','" + "Purchase Return" + "')";
                                    command2.ExecuteNonQuery();
                                    connection.Close();
