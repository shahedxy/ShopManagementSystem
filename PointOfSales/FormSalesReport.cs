    ...
    public partial class FormSalesReport : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                dataGridView1.Columns[12].HeaderText = "Sales By";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                PdfWriter wri = PdfWriter.GetInstance(doc, new FileStream(System.AppDomain.CurrentDomain.BaseDirectory.ToString() + "\\Documents\\Sales Report" + DateTime.Now.Date.ToString("ddMMyyyy") + ".pdf", FileMode.Create));
                ...
                System.Diagnostics.Process.Start(System.AppDomain.CurrentDomain.BaseDirectory.ToString() + "\\Documents\\Sales Report" + DateTime.Now.Date.ToString("ddMMyyyy") + ".pdf");
            }
        }
            ...
            else
            {
                ...
                try
                {
                    ...
                    if (comboBoxSearchBy.Text == "Invoice Number")
                    {
                        ...
                        query = "select * from InvoiceInformation Where InvoiceNumber='" + textBoxQuery.Text + "'";
                    }

                    else if (comboBoxSearchBy.Text == "Customer Name")
                    {
                        query = "select * from InvoiceInformation Where SalesDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "' And CustomerName='" + textBoxQuery.Text + "'";
                    }

                    else if (comboBoxSearchBy.Text == "Account Number")
                    {
                        query = "select * from InvoiceInformation Where SalesDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "' And AccountNumber='" + textBoxQuery.Text + "'";
                    }

                    else if (comboBoxSearchBy.Text == "Contact Number")
                    {
                        query = "select * from InvoiceInformation Where SalesDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "' And ContactNumber='" + textBoxQuery.Text + "'";
                    }

                    else if (comboBoxSearchBy.Text == "Operator Name")
                    {
                        query = "select * from InvoiceInformation Where SalesDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "' And SalesBy='" + textBoxQuery.Text + "'";
                    }


                    else if (comboBoxSearchBy.Text == "Date To Date")
                    {
                        query = "select * from InvoiceInformation Where SalesDate BETWEEN '" + dateTimePicker1.Value.ToString("yyyy/MM/dd") + "' AND '" + dateTimePicker2.Value.ToString("yyyy/MM/dd") + "'";
                    }
        ...
        void AutoComplete1()
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    string groupName = reader["CustomerName"].ToString();
                    coll.Add(groupName);
                }
        ...
        void AutoComplete2()
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    string groupName = reader["SalesBy"].ToString();
                    coll.Add(groupName);
                }
            ...
            if (e.ColumnIndex == 13)
            {
                ...
                if (dr == DialogResult.Yes)
                {
                    ...
                    try
                    {
                        ...
                        string query = "update InvoiceInformation set ChangeMoney='" + "0" + "' where ID=" + row.Cells[0].Value.ToString() + " ";
