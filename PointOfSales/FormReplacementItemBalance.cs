...
{
    public partial class FormReplacementItemBalance : Form
    {
        ...
        public FormReplacementItemBalance()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string query = "select * from ReplacementInformation";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        query = "select * from ReplacementInformation Where ItemCode='" + textBoxQuery.Text + "'";
                    }


                    else if (comboBoxSearchBy.Text == "Item Name")
                    {
                        query = "select * from ReplacementInformation Where ItemName='" + textBoxQuery.Text + "'";
                    }

                    else if (comboBoxSearchBy.Text == "Group Name")
                    {
                        query = "select * from ReplacementInformation Where GroupName='" + textBoxQuery.Text + "'";
                    }

                    else if (comboBoxSearchBy.Text == "Company Name")
                    {
                        query = "select * from ReplacementInformation Where CompanyName='" + textBoxQuery.Text + "'";
                    }

                    else if (comboBoxSearchBy.Text == "Shelf Number")
                    {
                        query = "select * from ReplacementInformation Where SelfNumber='" + textBoxQuery.Text + "'";
                    }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                PdfWriter wri = PdfWriter.GetInstance(doc, new FileStream(System.AppDomain.CurrentDomain.BaseDirectory.ToString() + "\\Documents\\Replace Item Stock Balance" + DateTime.Now.Date.ToString("ddMMyyyy") + ".pdf", FileMode.Create));
                ...
                PdfPCell cell = new PdfPCell(new Phrase("Replace Item Stock Balance"));
                ...
                System.Diagnostics.Process.Start(System.AppDomain.CurrentDomain.BaseDirectory.ToString() + "\\Documents\\Replace Item Stock Balance" + DateTime.Now.Date.ToString("ddMMyyyy") + ".pdf");
            }
        }
    }
}
